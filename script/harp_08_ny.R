...
rain<-read.csv("data/rain_prob_edit.csv")
...
## If you want to rename the x and y axes...
roc(rain$bin, rain$p24_cat0, plot=TRUE, legacy.axes=TRUE, percent=TRUE, xlab="False Positive Percentage", ylab="True Postive Percentage")
