...
# # Object in R (Variable)
# my_obj <- 48 # assign an integer value
# my_obj # call the object
# 
# my_obj2 <- "R is cool"  # assign a char value
# my_obj2
# 
# # my_obj2 <- R is cool # intentional error
# my_obj2 <- 1024 # re-assign an object to another value
# 
# my_obj3 <- my_obj + my_obj2 # making 
# my_obj3
# 
# char_obj <- "hello"
# char_obj2 <- "world!"
...
# With arguments
new.function <- function(a=1,b=1,c=1) {
  result <- a * b + c
  print(result)
}
...
class(c("2012-01-01", "2013-09-23", "2014-11-15", "2014-05-11","2015-03-27"))
